    ...
    <div className="flex md:flex-row flex-col md:justify-between items-center md:items-start gap-8 md:gap-0 bg-gray-800 mt-16 p-8 rounded-lg">
      <div className="flex flex-col items-center md:items-start gap-4">
        <Link href="/" className="flex items-center">
          <Image src="/logo.png" alt="TrendFit" width={36} height={36} />
          <p className="hidden md:block pl-2 font-medium text-md text-white tracking-wider">
            TRENDFIT
          </p>
        </Link>
        <p className="text-gray-400 text-sm">© 2025 TrendFit.</p>
